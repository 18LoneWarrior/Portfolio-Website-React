    ...
    return (
        <>
            <div className="border-b border-neutral-900 ">
                <motion.h2 whileInView={{opacity:1, y:0}} initial={{opacity:0, y:-100}} transition={{duration: 0.6}} className="text-center text-4xl my-10 ">Contact</motion.h2>
                    ...
                    <div className="text-center tracking-tighter">
                        <div className="flex flex-wrap lg:justify-center mb-8">
                            <motion.div whileInView={{opacity: 1, x: 0}} initial={{opacity: 0, x: -100}}
                                ...
                                <svg fill="#dfc311" width="200px" height="200px" viewBox="-5.12 -5.12 42.24 42.24"
                                     version="1.1" xmlns="http://www.w3.org/2000/svg" stroke="#dfc311" strokeWidth="0.00032">
                                    <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
                                    <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
                                    <g id="SVGRepo_iconCarrier"><title>phone-call</title>
                                        <path
